...
**注意詞**：utm_source=chatgpt.com、utm_source=openai、referrer=grok.com、turn0search、oaicite、contentReference、[cite: 1]、[object Object]、Markdown 標記錯置。
...
5. 修出**最終稿**，確認沒有破折號（模式 27）、沒有大陸用語（模式 34）、沒有簡轉繁錯誤（模式 35）。
